...
<body style="background-image: url('<?= base_url() ?>/assets/users/<?= $kunci; ?>/bg-tamu.png');">
    ...
    <div class="container" style="padding-top:10px">
            ...
            <div class="col-sm-8">
                ...
                foreach($slider as $key => $data) {
                    ...
                    echo '<div class="item ' . $active . '">' ?>
                        <img src="<?php echo base_url() ?>/assets/users/<?php echo $kunci.'/'.$data['nama_slider']; ?>.png"
                            alt="img-fluid">
                    </div>
                    <?php }
                ?>
        ...
        <div class="col-sm-4">
            <div class="well couple-info">
                <p class="utama-mempelai"><u><?php echo $nama_panggilan_pria; ?> &
                        <?php echo $nama_panggilan_wanita; ?></u></p>
                <b>
    ...
    <div class="container text-center" id="scan-hadir-tamu">
        <div class="row">
            <div class="col col-sm-3">
                ...
                <div class="well">
                    <a id="btn-scan-qr">
                        <img src="<?php echo base_url() ?>/assets/dashboard/img/qrscan.png" alt="Image"
                            class="img-fluid">
                    </a>
            ...
            <div class="col col-sm-3">
                <b>
                    <h4>Capture Foto Selfi</h4>
                </b>
                <div class="well" id="canvas-camera">
                    <a id="btn-capture" onClick="configure()">
                        <img src="<?php echo base_url() ?>/assets/bukutamu/img/photo-capture.png" alt="Image"
                            class="img-fluid"></a>
                    <div id="camera" hidden="" style="display:none;"></div>
                    <div id="webcam" hidden="" style="display:none;">
                        <input type="button" class="btn btn-sm btn-danger" value="Capture" id="btn-capture"
                            onClick="preview()">
                    </div>
                ...
                <div class="well">
                    ...
                    <div class="col mt-2" id="qr-result">
                        ...
                        <input id="outputData" type="text" class="form-control" onfocus="autofill(this.value)"
                            placeholder="QR Code Tamu Undangan" required>
                    </div>

                    <div class="col mt-2">
                        <label>Nama Tamu</label>
                        <input id="nama_tamu" type="text" class="form-control" placeholder="Contoh : Jack Dawson S.Kom"
                            value="" disabled required>
                    </div>

                    <div class="col mt-2">
                        <label>Alamat Tamu</label>
                        <input id="alamat_tamu" type="text" class="form-control" placeholder="Contoh : Jack" value=""
                            disabled required>
                    </div>
                </div>
            </div>
            ...
            ?>
                        <li class="list-group-item">
                            <strong><?= $row->nama_tamu ?></strong><br><small><?= $row->alamat_tamu ?></small></li>
                        <?php }
             } ?>
                    </ul>
                </div>
