        ...
        <div class="row mb-5">
            ...
            <div class="col-md-4">
                <div class="couple-card mb-4">
                    <h3 class="text-center mb-3"><span class="accent-text"><?php echo $nama_panggilan_pria; ?> & <?php echo $nama_panggilan_wanita; ?></span></h3>
                    <p class="text-center mb-3 fw-bold" id="tanggal-acara-resepsi"></p>
                    <p class="text-center mb-2"><i class="fas fa-map-marker-alt me-2 accent-text"></i><?php echo $tempat; ?></p>
                    <p class="text-center"><i class="fas fa-location-dot me-2 accent-text"></i><?php echo $alamat; ?></p>
                </div>
                <div class="date-card">
            ...
            <div class="col-md-3">
                <div class="card h-100 text-center p-4">
                    ...
                    <a id="btn-scan-qr" class="d-block mb-3">
                        <img src="<?php echo base_url() ?>/assets/dashboard/img/qrscan.png" alt="Pemindai QR" class="img-fluid" style="max-width: 120px;">
                    </a>
                ...
                <div class="card h-100 text-center p-4">
                    ...
                    <div id="canvas-camera">
                        <a id="btn-capture" onClick="configure()">
                            <img src="<?php echo base_url() ?>/assets/bukutamu/img/photo-capture.png" alt="Kamera" class="img-fluid" style="max-width: 120px;">
                        </a>
            ...
            <div class="col-md-3">
                <div class="card h-100 p-4">
                    ...
                    <div class="mb-3" id="qr-result">
                        ...
                        <input id="outputData" type="text" class="form-control" onfocus="autofill(this.value)" placeholder="Scan QR Code" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Nama Tamu</label>
                        <input id="nama_tamu" type="text" class="form-control" placeholder="Contoh: Jack Dawson" value="" disabled required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Alamat</label>
                        <input id="alamat_tamu" type="text" class="form-control" placeholder="Alamat Tamu" value="" disabled required>
                    </div>
                </div>
            </div>
