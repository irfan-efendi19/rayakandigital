...
<link href="<?php echo base_url() ?>/assets/themes/watercolor3/themes/watercolor3/style.css?v=1.0.1" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/watercolor3/themes/style.css?v=1.0.1">
</head>
<body>
...
?>
    <section class="full header pt-0 pb-0">
        <div class="container">
            <div class="justify-content-center" data-aos="fade-down" data-aos-duration="2000">
                <h5 class="caption mb-3"><span id="tanggal-wedding"></span><input id="tgl_wedding" type="hidden" value="<?= $tgl_acara ?>" ></h5>
                    ...
                    <div class="col-md-4 mt-4 information-wrap" data-aos="fade-right">
                        <div class="information">
                            <div class="d-flex justify-content-center mb-4">
                                <img src=<?php echo base_url() ?>/assets/themes/watercolor3/themes/watercolor3/images/mahkota.png alt="mahkota" style="max-height:30px">
                            </div>
                            <h4 class="text-secondary"><?= $data->nama_acara ?></h4>
    ...
    <?php if($set->lokasi == 1 && !empty($maps)){?>
        ...
        <div class="container" data-aos="flip-down">
            <div class="d-flex justify-content-center mb-5">
                <img src=<?php echo base_url() ?>/assets/themes/watercolor3/themes/watercolor3/images/mahkota-t.png alt="mahkota" style="max-height:40px">
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                <img src=<?php echo base_url() ?>/assets/themes/watercolor3/themes/watercolor3/images/mahkota-b.png alt="mahkota" style="max-height:40px">
            </div>
        </div>
    </section>
        <?php } ?>
            ...
            <div class="col-md-12 text-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type=submit id="submitKomen" class="btn btn-primary px-5">Kirim <img src=<?php echo base_url() ?>/assets/themes/watercolor3/images/send-w.png alt="send icon" style="width:20px;margin-left:5px"></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="play-pause btn-play-pause" id="button-control"><img src=<?php echo base_url() ?>/assets/themes/watercolor3/images/play-pause.svg alt="play pause" width=25px></div>
    <?php if($set->hadiah == 1 && $order[0]->kirim_hadiah == 1) { ?>
                <button type=button class="btn-donation" data-toggle="modal" data-target="#modalGift">
        <img src=<?php echo base_url() ?>/assets/themes/watercolor3/images/gift-donation.png alt="donation" style="width:18px;margin-right:5px"> Kirim Hadiah
    </button>
    <?php } if($set->qrcode == 1 && $order[0]->buku_tamu == 1) { ?>
                <div class="btn-qrcode" id="button-control" data-toggle="modal" data-target="#modalQrCode"><img src=<?php echo base_url() ?>/assets/themes/watercolor3/images/qrcode.png alt="qrcode" width=25px></div>
    <?php } } ?>
    ...
    <script src=<?php echo base_url() ?>/assets/themes/watercolor3/js/musicv2.js?v=1.0.0></script>
        <script src=https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js></script>
<script src=<?php echo base_url() ?>/assets/themes/watercolor3/themes/watercolor3/moment-with-locales.js></script>
     <script src="<?php echo base_url() ?>/assets/themes/watercolor3/themes/watercolor3/jquery.classyqr.js"></script>
