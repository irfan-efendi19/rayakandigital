...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/hwflower/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/hwflower/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/hwflower/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/hwflower/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/undangan/font-awesome/css/all.css">
    <script src="<?php echo base_url() ?>/assets/themes/hwflower/js/jquery.min.js"></script>
 </head>

<body oncontextmenu="return false">

<!-- ============== HALAMAN AWAL =============== -->
<div class="thebegining" style="background-image: url('<?php echo base_url() ?>/assets/themes/hwflower/img/texture.png'); background-repeat: repeat;">
...
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/hwflower/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/hwflower/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/hwflower/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
      	...
      	<table style="width: 100%;margin-top:-50px"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
      		...
      		<tr>
      			<th style="text-align: center;">
                    ...
                    <span class="tanggal-weddingnya" id="tanggal-wedding"></span><input id="tgl_wedding" type="hidden" value="<?= $tgl_acara ?>">
                </th>
      		</tr>
      		<tr>
            ...
            <tr>
                <th style="position: relative;text-align: center;">
					...
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/hwflower/img/bg_flower.png" class="cover-border" /><br>
					<!-- image border cover -->
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/hwflower/img/bottom_flower.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/hwflower/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/hwflower/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/hwflower/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/hwflower/js/bootstrap.min.js" ></script>
...
<script src="<?php echo base_url() ?>/assets/themes/hwflower/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/hwflower/js/script.js"></script>
