...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/radiantyellow/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/radiantyellow/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/radiantyellow/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/radiantyellow/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/undangan/font-awesome/css/all.css">
    <script src="<?php echo base_url() ?>/assets/themes/radiantyellow/js/jquery.min.js"></script>
</head>

<body oncontextmenu="return false">

<!-- ============== HALAMAN AWAL =============== -->
<div class="thebegining" style="background-image: url('<?php echo base_url() ?>/assets/themes/radiantyellow/img/texture.png'); background-repeat: repeat;">
...
<div class="row d-flex justify-content-center text-center">
	...
	<div class="salam">
        ...
        ?></span><br>
        <br>
		<a style="font-weight: bold;font-size: 12px;color: #604e19;position: absolute;right: 0;left: 0;"><button id="buka-undangan" type="button" class="btn btn-warning" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">Buka Undangan</button></a>
	</div>
	</div>
    </div>
</div>	
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/radiantyellow/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/radiantyellow/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/radiantyellow/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div id="konten" style="z-index: 1;">
	...
	<div id="sampul-konten" class="konten" >                	
      	<table style="width: 100%;margin-top:-50px"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
      		...
      		<tr>
      			<th style="text-align: center;">
                    <span class="nama-mempelai"><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?></span><br>
            ...
            <tr>
                <th style="position: relative;text-align: center;display:block;margin-top:15px">
					
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/radiantyellow/img/bg_flower.png" class="cover-border" /><br>
					<!-- image border cover -->
			...
			<div class="layout-komen">				
				...
				<div class="komen" >
					<div class="col-12 komen-nama">
						<?php echo \esc($data['nama_komentar']); ?>
					</div>
					<div class="col-12 komen-isi">
						<?php echo \esc($data['isi_komentar']); ?>
					</div>
				</div>
				<?php } ?> 
			</div>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/radiantyellow/img/bottom_flower.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/radiantyellow/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/radiantyellow/img/kiri-bawah.png" >  -->
</div>
...
<i  class="fa fa-volume-up my-musik"></i></a>


<!-- mengirimkan data php ke javascript -->
<script>var base_url = '<?php echo base_url() ?>';</script>
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/radiantyellow/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/radiantyellow/js/bootstrap.min.js" ></script>
...
<script src="<?php echo base_url() ?>/assets/themes/radiantyellow/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/radiantyellow/js/script.js"></script>
