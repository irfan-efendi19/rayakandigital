...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/blueroses/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/blueroses/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/blueroses/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/blueroses/css/style.css">
...
<!-- ============== HALAMAN AWAL =============== -->
<!-- ============== HALAMAN AWAL =============== -->
<div class="thebegining" style="background-image: url('<?php echo base_url() ?>/assets/themes/greenflower/img/texture.png'); background-repeat: repeat;">
	...
	<div class="salam">
        ...
        ?></span><br>
        <br>
		<a style="font-weight: bold;font-size: 12px;color: #604e19;position: absolute;right: 0;left: 0;"><button id="buka-undangan" type="button" class="btn btn-primary" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">Buka Undangan</button></a>
	</div>
	</div>
    </div>
</div>	
...
<div id="konten" style="z-index: 1;">
    ...
    <div id="acara-konten" style="display: none;" class="konten">
	    ...
	    <div class="acaranya" >
    		...
    		$i++;?>
			<table class="tb-acara" style="margin-left:auto;margin-right:auto">
				<thead>
