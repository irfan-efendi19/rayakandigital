...
<html lang="id" class="no-js">
    ...
    <link rel="icon" href="<?= base_url() ?>/assets/users/<?= $kunci; ?>/kita.png">
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/tapis/tapis.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/css/swipebox.min.css">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
        <script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/jquery.countdown.min.js"></script>
            ...
            <div class="row" style="margin:0 auto;">
                <div class="col-md-6 col-sm-12 col-md-offset-3">
                    ...
                    <?php }
                     ?>
                    <p>
                        Selamat datang di undangan pernikahan Kami. <br>Gunakan browser Chrome atau Safari agar website tampil sempurna. Gunakan tombol arah di bawah utuk membuka halaman selanjutnya. 
                    </p>
                    <br>
                    <p>
                        <strong>KETUK UNTUK MELANJUTKAN</a></strong></p>
                </div>
            </div>
        </div>
<?php foreach ($data->getResult() as $row){
                        ...
                        <div class="col-md-12">
                            <div class="sw-invitation-home text-center  wow bounceInUp">
                               <h3><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?></h3>
                                ...
                                <figure>
                                    <img class="img-responsive" src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/tapis/img/sw-wedding-invitation.png">
                                </figure>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Terimakasih sudah mengirim pesan/doa untuk mempelai
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src=<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/tapis/img/love.png alt="donation" style="max-width: 60px;">
                    ...
                    ?> 
                        ...
                        <div class="col-12" style="text-align:center">
                            <b><?= $row->nama_bank ?> </b><br>
                                <span onClick='copyText(this)'><?= $row->no_rekening ?> <img src=<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/tapis/img/copy.png style="height:13px;margin-top:-5px;cursor:pointer"></span><br>
...
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/modernizr.custom.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/jquerypp.custom.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/jquery.bookblock.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/jquery.swipebox.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/sw-main.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/moment-with-locales.js"></script>
<script>var base_url = '<?php echo base_url() ?>';</script>
<script src="<?php echo base_url() ?>/assets/themes/tapis/themes-rsvp/sw-vendor/js/jquery.classyqr.js"></script>
<script>
