...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/sketchflower/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/sketchflower/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/sketchflower/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/sketchflower/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/undangan/font-awesome/css/all.css">
    <script src="<?php echo base_url() ?>/assets/themes/sketchflower/js/jquery.min.js"></script>
</head>

<body oncontextmenu="return false">

<!-- ============== HALAMAN AWAL =============== -->
<div class="thebegining" style="background-image: url('<?php echo base_url() ?>/assets/themes/sketchflower/img/texture.png'); background-repeat: repeat;">
...
<div class="dekorasi-all">
	...
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/sketchflower/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	 <img src="<?php echo base_url() ?>/assets/themes/sketchflower/img/kiri-atas.png" class="imgatas-kiri"> 
	<!-- GAMBAR DEKORASI KANAN --> 
	<!--<img src="<?php echo base_url() ?>/assets/themes/sketchflower/img/fl3_c2.png" class="imgatas-kanan"> -->
</div>
...
<div class="dekorasi-sampul">
	...
	<!-- <img src="<?php echo base_url() ?>/assets/themes/sketchflower/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/sketchflower/img/kanan-atas.png" class="imgatas-kanan"> -->
</div>
...
<div id="konten" style="z-index: 1;">
	...
	<div id="sampul-konten" class="konten" >                	
      	<table style="width: 100%;margin-top:-50px"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
            ...
            <tr>
                <th style="position: relative;text-align: center;display:block;margin-top:30px">
					<img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/kita.png" class="cover-foto"/>
					
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/sketchflower/img/flower.png" class="cover-border" /><br>
					<!-- image border cover -->
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/sketchflower/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	 <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/sketchflower/img/kanan-bawah.png" >  
	<!-- GAMBAR DEKORASI KIRI --> 
	<!--<img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/sketchflower/img/fl3_c4.png" > -->
</div>
...
<div class="dekorasi-sampul dekorasi-sampul-bawah">
	...
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/sketchflower/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/sketchflower/img/kiri-bawah.png" > -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/sketchflower/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/sketchflower/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/sketchflower/js/jquery.classyqr.js"></script>
...
<script src="<?php echo base_url() ?>/assets/themes/sketchflower/js/jquery-plugin-collection.js"></script>

<script src="<?php echo base_url() ?>/assets/themes/sketchflower/js/script.js"></script>
