...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Bebas+Neue|Lato:400,700|Merienda+One&&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css">
<link href="<?php echo base_url() ?>/assets/themes/watercolor2/themes/watercolor2/style.css?v=1.0.1" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/watercolor2/themes/style.css?v=1.0.1">
</head>
<body>
...
?>
    <section class="full header">
        <div class="container">
            <div class="col-md-12 top">
                <h5 class="mb-4"> We Are Getting Married </h5>
                <h1 class="text-secondary" data-aos="fade-up" data-aos-duration="1000"><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." <span>&</span> ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." <span>&</span> ".$nama_panggilan_pria;?></h1>
            </div>
            <div class="col-md-12 bottom mt-2 pt-5" data-aos="fade-up" data-aos-duration="2000">
    ...
    <section class="section-about-us">
        <div class="container">
            ...
            <div class="row mt-5">
                <div data-aos="fade-right" class="col-md-6 mb-5 <?php if($posisi_mempelai == 0) echo 'order-1'; ?>">
                    <div class="row">
                        <div class="col-md-12 px-5 couple-ring">
                            <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/bride.png" class="img-fluid">
                        </div>
                    </div>
                    <h3 class="caption display-5"><?= $nama_lengkap_wanita ?></h3>
                    <p>Putri dari Pasangan <br> Bpk <?= $nama_ayah_wanita ?> dan Ibu <?=$nama_ibu_wanita ?></p>
                    </div>
                <div data-aos="fade-left" class="col-md-6 mb-5 <?php if($posisi_mempelai == 1) echo 'order-1'; ?>">
                        <div class="row">
                        <div class="col-md-12 px-5 couple-ring">
                            <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/groom.png" class="img-fluid">
                        </div>
                    </div>
    ...
    <section class="section-information">
        <div class="container" style="max-width:1100px">
            <div class="d-flex justify-content-center mb-5">
                <img src=<?php echo base_url() ?>/assets/themes/watercolor2/themes/watercolor2/images/mahkota.svg alt="mahkota" style="max-width:80px;max-height:100px">
            </div>
            <div class="row justify-content-md-center">
                    <?php  $i = 0;
				    foreach($acara as $key => $data){ 
					$i++;?>
                    <div class="col-md-4 mt-4 information-wrap" data-aos="flip-left" data-aos-delay="100">
            ...
            <div class="d-flex justify-content-center mt-5">
                <img src=<?php echo base_url() ?>/assets/themes/watercolor2/themes/watercolor2/images/mahkota-b.svg alt="mahkota" style="max-width:80px;max-height:100px">
            </div>
        </div>
    </section>
    <?php if($set->lokasi == 1 && !empty($maps)) {?>
        ...
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-3 col-6 mb-2" data-aos="zoom-in-up" data-aos-delay="100">
                    <div class="timer timer-1 days">
                        00
                    </div>
                    <h4>DAYS</h4>
                </div>
                <div class="col-md-3 col-6 mb-2" data-aos="zoom-in-up" data-aos-delay="200">
            ...
            <div class="col-md-12 text-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type=submit id="submitKomen" class="btn btn-primary px-5">Kirim <img src=<?php echo base_url() ?>/assets/themes/watercolor2/images/send-b.png alt="send icon" style="width:20px;margin-left:5px"></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="play-pause btn-play-pause" id="button-control"><img src=<?php echo base_url() ?>/assets/themes/watercolor2/images/play-pause.svg alt="play pause" width=25px></div>
                <?php if($set->hadiah == 1 && $order[0]->kirim_hadiah == 1) { ?>
                <button type=button class="btn-donation" data-toggle="modal" data-target="#modalGift">
        <img src=<?php echo base_url() ?>/assets/themes/watercolor2/images/gift-donation.png alt="donation" style="width:18px;margin-right:5px"> Kirim Hadiah
    </button>
    <?php } if($set->qrcode == 1 && $order[0]->buku_tamu == 1) { ?>
                <div class="btn-qrcode" id="button-control" data-toggle="modal" data-target="#modalQrCode"><img src=<?php echo base_url() ?>/assets/themes/watercolor2/images/qrcode.png alt="qrcode" width=25px></div>
    <?php } } ?>
    ...
    <script src=<?php echo base_url() ?>/assets/themes/watercolor2/js/musicv2.js?v=1.0.0></script>
        <script src=https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js></script>
<script src=<?php echo base_url() ?>/assets/themes/watercolor2/themes/watercolor2/moment-with-locales.js></script>
     <script src="<?php echo base_url() ?>/assets/themes/watercolor2/themes/watercolor2/jquery.classyqr.js"></script>
