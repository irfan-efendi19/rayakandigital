...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/css/simplelightbox.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/arabian.css">
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery-3.1.0.min.js">
    </script>
</head>
        ...
        <div class="row" style="margin:0 auto;">
            <div class="col-md-6 col-sm-12 col-md-offset-3">
                ...
                <p>Selamat datang di undangan pernikahan Kami.
                    <br>Gunakan browser Chrome atau Safari agar website tampil sempurna. Gunakan tombol icon menu di
                    samping atau scroll untuk melihat halaman selanjutnya.
                </p>
                <br>
...
?>
    ...
    <div class="mainbag">
        <section vs-anchor="1" class="mainview sw-invitation-wrapper">
                        ...
                        <div class="sw-invitation-home text-center">
                            <div class="sw-content">
                                <h2 class="typewrite" data-period="2000"
                                    data-type='[ "The Wedding", "<?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?>", "Save Date" ]'>
                                </h2>
        ...
        <section vs-anchor="2" class="mainview sw-mempelai-warpper">
            <div class="vs-center-wrap">
                <div class="sw-content-inner">
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2"><img
                            class="sw-el-top"
                            src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/sw-element-top.png">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="sw-mempelai">
                                    ...
                                    <p class="sw-binti"> Putra dari Bpk. <?= $nama_ayah_pria ?> dan Ibu
                                        <?=$nama_ibu_pria ?></p>
                                </div>
                            </div>
                            <?php } ?>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="sw-mempelai">
                                    ...
                                    <p class="sw-binti"> Putri dari Bpk <?= $nama_ayah_wanita ?> dan Ibu
                                        <?=$nama_ibu_wanita ?></p>
                                </div>
                            </div>
                            ...
                            <?php } ?>
                        </div><img class="sw-el-bottom"
                            src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/sw-element-bottom.png">
                    </div>
                </div>
        </section>
                        ...
                        <div class="row">
                            ...
                            <div class="sw-ceremony col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="sw-akad-resepsi text-center">
                                    <div class="sw-icon"><span class="flaticon-wedding"></span></div>
                                    <h3><?= $data->nama_acara ?></h3>
                                    <p><span id="tanggal-acara<?= $i+1?>"></span><input id="tgl_acara<?= $i+1?>"
                                            type="hidden" value="<?= $data->tgl_acara ?>">
                                        <br> Jam <?= $data->waktu_mulai ?> - <?= $data->waktu_akhir ?>
                                        <br> <?= $data->tempat_acara ?><br><?= $data->alamat_acara ?>
                                    </p>
                                    <?php if($data->set_countdown == 'Y' && !empty($data->maps)){ ?>
                                    <a href="#" data-toggle="modal" data-target="#sw-maps" title="Lokasi">Buka di google
                                        map</a> <?php } ?>
                                </div>
                            </div>
                            <?php } ?>
        ...
        <?php foreach ($rules->getResult() as $set){ ?>
        <?php if($set->cerita == 1) { ?>
        <section vs-anchor="4" class="mainview sw-story-wrapper"
            style="background:url('<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/cover-prewed.jpg') no-repeat;">
            <div class="over"></div>
            <div class="vs-center-wrap">
                <div class="vs-center">
                    <div class="sw-content-inner">
        ...
        <section vs-anchor="5" class="mainview sw-mempelai-warpper">
            <div class="vs-center-wrap">
            ...
            <div class="vs-center-wrap">
                ...
                <div class="sw-content-inner text-center">
                                    ...
                                    <div class="col-md-5 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" name="nama" id="nama" class="form-control"
                                                value="<?= esc($invite) ?>" placeholder="Nama" required>
                                        </div>
                                    </div>
                    ...
                    <div class="sw-logo-kalaujodoh text-center">
                        ...
                        <h3><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?>
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="social-share text-center">
                        <ul>
                            <li>
                                <a class="facebook"
                                    href="http://www.facebook.com/sharer/sharer.php?u=<?= SITE_UNDANGAN ?>/<?= $web ?>"
                                    target="_blank">
                                    <i class="fa fa-facebook"></i>
                                </a>
                            </li>
                            <li>
                                <a class="twitter" href="http://twitter.com/share?url=<?= SITE_UNDANGAN ?>/<?= $web ?>"
                                    target="_blank">
                                    <i class="fa fa-twitter"></i>
                                </a>
                            </li>
                            <li>
                                <a class="wa" href="https://api.whatsapp.com/send?text=<?= SITE_UNDANGAN ?>/<?= $web ?>"
                                    target="_blank">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src=<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/love.png
                            alt="donation" style="max-width: 60px;">
                        <h5 class="font-bold text-center">Kirim Hadiah<br><small>Untuk
                                <?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?></small>
                        </h5>
                    </div>
                    <?php 
                    $i=1;
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align:center">
                            ...
                            <span onClick='copyText(this)'><?= $row->no_rekening ?> <img
                                    src=<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/copy.png
                        ...
                        <div style="display:flex;align-items:center;justify-content:center;">
                            <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/rekening/<?= $row->qrcode_bank ?>"
    ...
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.countdown.min.js">
    </script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.easing.min.js">
    </script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.mousewheel.min.js">
    </script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/viewScroller.min.js">
    </script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/simple-lightbox.min.js">
    </script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/sw-main.js"></script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/moment-with-locales.js">
    </script>
    <script>
    var base_url = '<?php echo base_url() ?>';
    </script>
    <script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.classyqr.js">
    </script>
    <script>
