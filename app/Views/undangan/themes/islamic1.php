...
<head>
   <?php foreach ($mempelai->getResult() as $row) {
    ...
    <link href="https://fonts.googleapis.com/css?family=Alice|Kurale&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css">
<link href="<?php echo base_url() ?>/assets/themes/islamic1/themes/islamic1/style.css?v=1.0.1" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/islamic1/themes/style.css?v=1.0.1">
</head>
<body>
            ...
            <div class="row justify-content-md-center" style="margin:0 auto;">
                <div class="col-md-6 col-sm-12 col-md-offset-3">
                    <?php foreach ($rules->getResult() as $set){ 
			         if($set->prokes == 0) { ?>
                    <img src="<?php echo base_url() ?>/assets/base/img/prokes.png">
                    <?php }
                     ?>
...
?>
    <section class="full header">
        <div class="container">
            <div class="d-flex justify-content-center mb-5">
                <img src=<?php echo base_url() ?>/assets/themes/islamic1/themes/islamic1/images/mahkota.svg alt="mahkota" style="max-width:80px;max-height:100px">
            </div>
            <div class="col-md-12">
                <h5>We Are Getting Married</h5>
                <h4 class="caption mb-3"><span id="tanggal-wedding"></span><input id="tgl_wedding" type="hidden" value="<?= $tgl_acara ?>" ></h4>
                        <h1 class="text-secondary" data-aos="fade-up" data-aos-duration="1000"><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria."<br>&<br> ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita."<br>&<br>".$nama_panggilan_pria;?></h1>
                            </div>
                        <div class="col-md-12 mt-3 pt-5"  data-aos="fade-up" data-aos-duration="3000">
    ...
    <section>
        <div class="container">
            <div class="col-md-12" data-aos="flip-up">
                <h2 class="text-secondary">BRIDE <span>&</span> GROOM</h2>
            </div>
            <div class="col-md-10 offset-md-1" data-aos="flip-up">
                <?= nl2br($salam_pembuka) ?><br ><br >
            </div>
            <div class="row mt-5">
                <div data-aos="zoom-out" data-aos-delay="200" class="col-md-6 mb-5  <?php if($posisi_mempelai == 0) echo 'order-1'; ?>">
                    <div class="row">
                    ...
                    <h3 class="text-secondary"><?= $nama_panggilan_wanita ?></h3>
                    <h3 class="caption display-5"><?= $nama_lengkap_wanita ?></h3>
                    <p>Putri dari Pasangan <br> Bpk <?= $nama_ayah_wanita ?> dan Ibu <?=$nama_ibu_wanita ?></p>
                                            
                </div>
                <div data-aos="zoom-out" data-aos-delay="200" class="col-md-6 mb-5 <?php if($posisi_mempelai == 1) echo 'order-1'; ?>">
                                        <div class="row">
                        <div class="col-md-12 px-5 couple-ring">
                            <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/groom.png" alt="Romeo Photo" class="img-fluid rounded-circle">
                        </div>
                    </div>
                                        <h3 class="text-secondary"><?= $nama_panggilan_pria ?></h3>
                    <h3 class="caption display-5"><?= $nama_lengkap_pria ?></h3>
                    <p>Putra dari Pasangan <br> Bpk. <?= $nama_ayah_pria ?> dan Ibu <?=$nama_ibu_pria ?></p>
        ...
        <div class="container">
            ...
            <div class="col-md-12 pt-4">
                <p><span>"</span><?= \esc($quote) ?><span>"</span></p>
                    <h3 class="caption text-secondary"><?= \esc($sumber_quote) ?></h3>
                            </div>
            <div class="d-flex justify-content-center mt-5">
                <img src=<?php echo base_url() ?>/assets/themes/islamic1/themes/islamic1/images/mahkota-b.svg alt="mahkota" style="max-width:80px;max-height:100px">
            </div>
        </div>
    </section>
            ...
            <div class="col-md-12 text-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type=submit id="submitKomen" class="btn btn-primary px-5">Kirim <img src=<?php echo base_url() ?>/assets/themes/islamic1/images/send-b.png alt="send icon" style="width:20px;margin-left:5px"></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="play-pause btn-play-pause" id="button-control"><img src=<?php echo base_url() ?>/assets/themes/islamic1/images/play-pause.svg alt="play pause" width=25px></div>
                <?php if($set->hadiah == 1 && $order[0]->kirim_hadiah == 1) { ?>
                <button type=button class="btn-donation" data-toggle="modal" data-target="#modalGift">
        <img src=<?php echo base_url() ?>/assets/themes/islamic1/images/gift-donation.png alt="donation" style="width:18px;margin-right:5px"> Kirim Hadiah
    </button>
    <?php } if($set->qrcode == 1 && $order[0]->buku_tamu == 1) { ?>
                <div class="btn-qrcode" id="button-control" data-toggle="modal" data-target="#modalQrCode"><img src=<?php echo base_url() ?>/assets/themes/islamic1/images/qrcode.png alt="qrcode" width=25px></div>
    <?php } } ?>
    ...
    <script src=<?php echo base_url() ?>/assets/themes/islamic1/js/musicv2.js?v=1.0.0></script>
    <script src=https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js></script>
    <script src=<?php echo base_url() ?>/assets/themes/islamic1/themes/islamic1/moment-with-locales.js></script>
    <script src="<?php echo base_url() ?>/assets/themes/islamic1/themes/islamic1/jquery.classyqr.js"></script>
