...
<link href="<?php echo base_url() ?>/assets/themes/watercolor5/themes/watercolor5/style.css?v=1.0.1" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/watercolor5/themes/style.css?v=1.0.1">
</head>
<body>
...
?>
    <section class="full header">
        <div class="container">
            <div class="col-md-12" data-aos="fade-down" data-aos-delay="100">
                <h6 class="mb-5">SAVE THE DATE</h6>
                <h5 class="text-blue mb-4"> WE ARE GETTING MARRIED </h5>
                <h1 class="text-secondary">
                    <?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." <span class='d-block h5 font-weight-bold'>AND</span> ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." <span class='d-block h5 font-weight-bold'>AND</span> ".$nama_panggilan_pria;?></h1>
                <h5 class="text-blue mt-4 mb-3 border-bottom d-inline-block"><span id="tanggal-wedding"></span><input id="tgl_wedding" type="hidden" value="<?= $tgl_acara ?>" ></h5>
            </div>
                        <div class="col-md-12 mt-2 pt-5" data-aos="fade-up" data-aos-delay="200">
    ...
    <section class="pb-1">
        <div class="container">
            <div class="d-flex justify-content-center mb-3">
                <h2 class="text-blue display-5">Quotes</h2>
            </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row mt-5">
                <div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-6 mb-5  <?php if($posisi_mempelai == 0) echo 'order-1'; ?>">
                                        <div class="row">
                ...
                <div data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-delay="100" data-aos-duration="1000" class="col-md-6 mb-5 <?php if($posisi_mempelai == 1) echo 'order-1'; ?>">
                                        <div class="row">
                        <div class="col-md-12 px-5 couple-ring">
    ...
    <section>
        ...
        <div class="container" style="max-width:1000px">
            <div class="col-md-12">
                <h2 class="text-blue display-5">Our Gallery</h2>
            </div>
            <div class="row mt-5">
       ...
       <?php } if (!empty($youtube)) {?> 
        ...
        <div class="container" data-aos="fade-up">
            <div class="col-md-12 mb-5">
                <h2 class="text-blue display-5">Our Video</h2>
            </div>
        ...
        <div class="container" style="max-width:1000px">
            <div class="col-md-12 mb-5">
                <h2 class="text-blue display-5">Love Story</h2>
            </div>
        ...
        <div class="container">
            <div class="col-md-12 mb-5">
                <h2 class="text-blue display-5">Time To Happy Day</h2>
            </div>
            <div class="row justify-content-md-center">
                <div class="col-12">
    ...
    <?php if($set->lokasi == 1 && !empty($maps)){?>
        ...
        <div class="container" data-aos="flip-up">
            <div class="col-md-12">
                <h2 class="text-blue display-5">Map Location</h2>
            </div>
        ...
        <div class="container">
            <div class="col-md-12 mb-5">
                <h2 class="text-blue display-5">Beri Ucapan</h2>
            </div>
        </div>
                <div class="container" data-aos="fade-up">
            <div class="col-md-12 text-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type=submit id="submitKomen" class="btn btn-primary px-5">Kirim <img src=<?php echo base_url() ?>/assets/themes/watercolor5/images/send-w.png alt="send icon" style="width:20px;margin-left:5px"></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="play-pause btn-play-pause" id="button-control"><img src=<?php echo base_url() ?>/assets/themes/watercolor5/images/play-pause.svg alt="play pause" width=25px></div>
    <?php if($set->hadiah == 1 && $order[0]->kirim_hadiah == 1) { ?>
                <button type=button class="btn-donation" data-toggle="modal" data-target="#modalGift">
        <img src=<?php echo base_url() ?>/assets/themes/watercolor5/images/gift-donation.png alt="donation" style="width:18px;margin-right:5px"> Kirim Hadiah
    </button>
    <?php } if($set->qrcode == 1 && $order[0]->buku_tamu == 1) { ?>
                <div class="btn-qrcode" id="button-control" data-toggle="modal" data-target="#modalQrCode"><img src=<?php echo base_url() ?>/assets/themes/watercolor5/images/qrcode.png alt="qrcode" width=25px></div>
    <?php } } ?>
    ...
    <script src=<?php echo base_url() ?>/assets/themes/watercolor5/js/musicv2.js?v=1.0.0></script>
        <script src=https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js></script>
<script src=<?php echo base_url() ?>/assets/themes/watercolor5/themes/watercolor5/moment-with-locales.js></script>
     <script src="<?php echo base_url() ?>/assets/themes/watercolor5/themes/watercolor5/jquery.classyqr.js"></script>
