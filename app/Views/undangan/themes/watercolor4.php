...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,600;1,500&family=Sacramento&display=swap" rel="stylesheet">
<link href="https://fonts.googleapis.com/css2?family=Marck+Script&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css">
<link href="<?php echo base_url() ?>/assets/themes/watercolor4/themes/watercolor4/style.css?v=1.0.1" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/watercolor4/themes/style.css?v=1.0.1">
</head>
<body>
...
?>
    <section class="full header">
        <div class="container">
            <div class="col-md-12" data-aos="fade-down" data-aos-delay="100">
                <h6 class="mb-5">THE WEDDING OF</h6>
                <h1 class="text-secondary">
                <?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." <span class='h5 my-3 font-weight-bold'><b>and</b></span> ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." <span class='h5 my-3 font-weight-bold'><b>and</b></span> ".$nama_panggilan_pria;?></h1>
                                <h5 class="text-blue mt-3 mb-3 d-inline-block">
                    <div class="d-inline-block date"><?= date('M', strtotime($tgl_acara)) ?></div>
                    <div class="d-inline-block date-center"><?= date('D', strtotime($tgl_acara)) ?><br>
                    <b><?= date('d',strtotime($tgl_acara)) ?></b></div>
                    <div class="d-inline-block date"><?= date('Y',strtotime($tgl_acara)) ?></div>
                </h5>
            </div>
                        <div class="col-md-12 mt-2 pt-3" data-aos="fade-up" data-aos-delay="200">
    ...
    <section>
        <div class="container mb-5" style="max-width: 1000px">
            <img src=<?php echo base_url() ?>/assets/themes/watercolor4/themes/watercolor4/images/bg-flower2.png alt="flower" class="img-fluid">
        </div>
        <div class="container">
            ...
            <div class="row mt-5">
                <div data-aos="fade-down-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-md-6 mb-5 <?php if($posisi_mempelai == 0) echo 'order-1'; ?>">
                                        <div class="row">
                        <div class="col-md-12 px-5 couple-ring">
                            <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/bride.png" alt="Juliet Photo" class="img-fluid rounded-circle">
                        </div>
                    </div>
                                        <h3 class="caption text-blue display-5"><?= $nama_lengkap_wanita ?></h3>
                    <p class="text-secondary font-weight-bold">Putri dari Pasangan <br> Bpk <?= $nama_ayah_wanita ?> dan Ibu <?=$nama_ibu_wanita ?></p>
                </div>
                <div data-aos="fade-down-right" data-aos-easing="ease-out-cubic" data-aos-delay="100" data-aos-duration="1000" class="col-md-6 mb-5 <?php if($posisi_mempelai == 1) echo 'order-1'; ?>">
                                        <div class="row">
                        <div class="col-md-12 px-5 couple-ring">
                            <img src="<?= base_url() ?>/assets/users/<?= $kunci; ?>/groom.png" alt="Romeo Photo" class="img-fluid rounded-circle">
                        </div>
                    </div>
                                        <h3 class="caption text-blue display-5"><?= $nama_lengkap_pria ?></h3>
                    <p class="text-secondary font-weight-bold">Putra dari Pasangan <br>  Bpk. <?= $nama_ayah_pria ?> dan Ibu <?=$nama_ibu_pria ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container" style="max-width:1100px">
            <div class="row justify-content-md-center">
					...
					$i++;?>
                    <div class="col-md-4 mt-4 information-wrap" data-aos="fade-up" data-aos-delay="100">
                        <div class="information">
                            <h3 class="caption text-secondary"><?= $data->nama_acara ?></h3>
    ...
    <?php if($set->quote == 1) {?>
        ...
        <div class="container">
            ...
            <div class="col-md-12 pt-4">
                    ...
                    <h4 class="caption text-blue"><?= \esc($sumber_quote) ?></h4>
                            </div>
        </div>
    </section>
        ...
        <div class="container" style="max-width:1000px">
            <div class="col-md-12">
                <h2 class="text-blue display-4">Our Gallery</h2>
            </div>
            <div class="row mt-5">
       ...
       <?php } if (!empty($youtube)) {?> 
        ...
        <div class="container" style="max-width:1000px">
            <div class="col-md-12 mb-5">
                <h2 class="text-blue display-4">Love Story</h2>
            </div>
            <div class="col-md-12 text-left">
                <div class="owl-carousel">
                    <?php foreach($cerita as $key => $data) { ?> 
                        <div class="p-2" data-aos="fade-up" data-aos-delay="100">
                            <h4 class="mt-0 mb-1 text-uppercase"><?php echo $data['judul_cerita']; ?></h4>
                            <small class="pull-right d-block text-secondary"><span class="date"><?php echo $data['tanggal_cerita']; ?></span></small>
                            <p class="mt-3"><?php echo $data['isi_cerita']; ?></p>
                        </div>
                        <?php } ?>
                    </div>
            </div>
    ...
    <?php }
    if($set->lokasi == 1 && !empty($maps)) {?>
        <section class="my-5">
        <div class="container" data-aos="flip-up">
            <div class="col-md-12">
                <h2 class="text-blue display-4">Map Location</h2>
            </div>
        ...
        <div class="container">
            <div class="col-md-12 mb-5">
                <h2 class="display-4">Time To Happy Day</h2>
            </div>
            <div class="row justify-content-md-center">
                <div class="col-12">
                    <span class="expired"></span>
                </div>
                <div class="col-md-3 col-6 mb-2" data-aos="fade-right" data-aos-delay="100">
                    <div class="timer days">
                        00
                    </div>
                    <h5 class="text-secondary">DAYS</h5>
                </div>
                <div class="col-md-3 col-6 mb-2" data-aos="fade-right" data-aos-delay="200">
                    <div class="timer hours">
                        00
                    </div>
                    <h5 class="text-secondary">HOURS</h5>
                </div>
                <div class="col-md-3 col-6 mb-2" data-aos="fade-right" data-aos-delay="300">
                    <div class="timer minutes">
                        00
                    </div>
                    <h5 class="text-secondary">MINUTES</h5>
                </div>
                <div class="col-md-3 col-6 mb-2" data-aos="fade-right" data-aos-delay="400">
        ...
        <div class="container">
        <div class="col-md-12">
            <h2 class="display-4">Beri Ucapan</h2>
        </div>
    </div>
    <section class="black">
            ...
            <div class="col-md-12 text-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type=submit id="submitKomen" class="btn btn-primary px-5">Kirim <img src=<?php echo base_url() ?>/assets/themes/watercolor4/images/send-w.png alt="send icon" style="width:20px;margin-left:5px"></button>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <div class="col-md-12 mb-3 komen">
                            <div class="media px-3 media-comment">
                                ...
                                <div class="media-body">
                                    <div class="mb-2">
                                        <h5 class="h5 mb-0 text-secondary"><?= \esc($data['nama_komentar']); ?></h5>
                                    </div>
    ...
    <div class="play-pause btn-play-pause" id="button-control"><img src=<?php echo base_url() ?>/assets/themes/watercolor4/images/play-pause.svg alt="play pause" width=25px></div>
    <?php if($set->hadiah == 1 && $order[0]->kirim_hadiah == 1) { ?>
                <button type=button class="btn-donation" data-toggle="modal" data-target="#modalGift">
        <img src=<?php echo base_url() ?>/assets/themes/watercolor4/images/gift-donation.png alt="donation" style="width:18px;margin-right:5px"> Kirim Hadiah
    </button>
    <?php } if($set->qrcode == 1 && $order[0]->buku_tamu == 1) { ?>
                <div class="btn-qrcode" id="button-control" data-toggle="modal" data-target="#modalQrCode"><img src=<?php echo base_url() ?>/assets/themes/watercolor4/images/qrcode.png alt="qrcode" width=25px></div>
    <?php } } ?>
    ...
    <script src=<?php echo base_url() ?>/assets/themes/watercolor4/js/musicv2.js?v=1.0.0></script>
        <script src=https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js></script>
<script src=<?php echo base_url() ?>/assets/themes/watercolor4/themes/watercolor4/moment-with-locales.js></script>
     <script src="<?php echo base_url() ?>/assets/themes/watercolor4/themes/watercolor4/jquery.classyqr.js"></script>
