...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/vintage-islamic/vintage-islamic.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/css/swipebox.min.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/jquery.countdown.min.js"></script>
						...
						<div class="sw-content-inner sw-content-flex">
							<div class="col-md-12">
								...
								<p><span id="tanggal-wedding"></span><input id="tgl_wedding" type="hidden" value="<?= $tgl_acara ?>" ></p>
									<figure><img class="img-responsive" src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/vintage-islamic/img/sw-wedding-invitation.png"></figure>
									<div class="sw-kepada">
				...
				<div class="sw-content">
					<div class="sw-content-inner">
							...
							<div class="sw-ceremony"><img class="sw-el-top"
									src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/vintage-islamic/img/sw-element-top.png">
								...
								<img
									class="sw-el-bottom"
									src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/vintage-islamic/img/sw-element-bottom.png">
							</div>
...
<div class="modal fade" id="sw-hadiah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src=<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/vintage-islamic/img/love.png alt="donation" style="max-width: 60px;">
                    ...
                    ?> 
                        ...
                        <div class="col-12" style="text-align:center">
                            <b><?= $row->nama_bank ?> </b><br>
                                <span onClick='copyText(this)'><?= $row->no_rekening ?> <img src=<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/vintage-islamic/img/copy.png style="height:13px;margin-top:-5px;cursor:pointer"></span><br>
	...
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/modernizr.custom.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/jquerypp.custom.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/jquery.bookblock.min.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/jquery.swipebox.min.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/sw-main.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/moment-with-locales.js"></script>
<script>var base_url = '<?php echo base_url() ?>';</script>
<script src="<?php echo base_url() ?>/assets/themes/vintage-islamic/themes-rsvp/sw-vendor/js/jquery.classyqr.js"></script>
<script>
