...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/prettyflower/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/prettyflower/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/prettyflower/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/prettyflower/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/undangan/font-awesome/css/all.css">
    <script src="<?php echo base_url() ?>/assets/themes/prettyflower/js/jquery.min.js"></script>
</head>

<body oncontextmenu="return false">

<!-- ============== HALAMAN AWAL =============== -->
<div class="thebegining" style="background-image: url('<?php echo base_url() ?>/assets/themes/prettyflower/img/texture.png'); background-repeat: repeat;">
...
<div class="dekorasi-all">
	...
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/prettyflower/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/prettyflower/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<img src="<?php echo base_url() ?>/assets/themes/prettyflower/img/kanan-atas.png" class="imgatas-kanan"> 
</div>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/prettyflower/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/prettyflower/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/prettyflower/img/kiri-bawah.png" > 
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/prettyflower/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/prettyflower/js/bootstrap.min.js" ></script>
...
<script src="<?php echo base_url() ?>/assets/themes/prettyflower/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/prettyflower/js/script.js"></script>
