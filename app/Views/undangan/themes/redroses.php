...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/redroses/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/redroses/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/redroses/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/redroses/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>/assets/undangan/font-awesome/css/all.css">
    <script src="<?php echo base_url() ?>/assets/themes/redroses/js/jquery.min.js"></script>
</head>

<body oncontextmenu="return false">

<!-- ============== HALAMAN AWAL =============== -->
<div class="thebegining" style="background-image: url('<?php echo base_url() ?>/assets/themes/redroses/img/texture.png'); background-repeat: repeat;">
	...
	<div class="salam">
        ...
        ?></span><br>
        <br>
		<a style="font-weight: bold;font-size: 12px;color: #604e19;position: absolute;right: 0;left: 0;"><button id="buka-undangan" type="button" class="btn btn-danger" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">Buka Undangan</button></a>
	</div>
	</div>
    </div>
</div>	
...
<div class="dekorasi-all">
	...
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/redroses/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	<img src="<?php echo base_url() ?>/assets/themes/redroses/img/kiri-atas.png" class="imgatas-kiri">
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/redroses/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
      	...
      	<table style="width: 100%;margin-top:-50px"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
			...
			<tr>
                <th style="position: relative;text-align: center;display:block;margin-top:40px">
					...
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/redroses/img/bg-flower.png" class="cover-border" /><br>
					<!-- image border cover -->
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/redroses/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/redroses/img/kanan-bawah.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/redroses/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/redroses/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/redroses/js/bootstrap.min.js" ></script>
...
<script src="<?php echo base_url() ?>/assets/themes/redroses/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/redroses/js/script.js"></script>
