...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/rustic/rustic.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/css/swipebox.min.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/jquery.countdown.min.js"></script>
						...
						<div class="sw-content-inner sw-content-flex">
							<div class="col-md-12">
								<div class="sw-invitation-home text-center">
									...
									<div class="sw_weddingname">
										<div class="sw_des">
										    <?php if($posisi_mempelai == 0) echo "<h3>".$nama_panggilan_pria."</h3><h4>&</h4> <h3>".$nama_panggilan_wanita."</h3>"; else echo "<h3>".$nama_panggilan_wanita."</h3><h4>&</h4><h3>".$nama_panggilan_pria."</h3>";?>
				...
				<div class="sw-content">
					<div class="sw-content-inner">
							...
							<div class="sw-ceremony"><img class="sw-el-top"
									src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/rustic/img/sw-element-top.png">
								...
								<img
									class="sw-el-bottom"
									src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/rustic/img/sw-element-bottom.png">
							</div>
...
<div class="modal fade" id="sw-hadiah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src=<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/rustic/img/love.png alt="donation" style="max-width: 60px;">
                    ...
                    ?> 
                        ...
                        <div class="col-12" style="text-align:center">
                            <b><?= $row->nama_bank ?> </b><br>
                                <span onClick='copyText(this)'><?= $row->no_rekening ?> <img src=<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/rustic/img/copy.png style="height:13px;margin-top:-5px;cursor:pointer"></span><br>
	...
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/modernizr.custom.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/jquerypp.custom.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/jquery.bookblock.min.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/jquery.swipebox.min.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/sw-main.js"></script>
	<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/moment-with-locales.js"></script>
<script>var base_url = '<?php echo base_url() ?>';</script>

<script src="<?php echo base_url() ?>/assets/themes/rustic/themes-rsvp/sw-vendor/js/jquery.classyqr.js"></script>
<script>
