...
?>
    ...
    <div class="blocked" style="z-index:99999999;background:#f5f6fa;position:absolute;left:0;right:0;top:0;bottom:0;">
        ...
        <div class="content-thebegining">
            <img src="<?php echo base_url() ?>/assets/base/img/logo3.svg" style="width:100px;height: 100px;"> <br>
        </div>

        <div class="blocked_message"
            style="display: flex;justify-content: center;align-items: center;height: 100vh;flex-direction: column;position:absolute;top:0;bottom:0;left:0;right:0;">
            <a style="font-weight: bold;font-size: 22px;color: #e74c3c;">Undangan Tidak Aktif!</a>
            <a style="font-weight: bold;font-size: 13px;color: #34495e;text-align:center;">Segera lakukan pembayaran
                agar undangan anda bisa aktif!</a>
        </div>
    ...
    <div class="warning" style="z-index:9999999;background:#fff200;position:absolute;left:0;right:0;top:0;">

        <div class="warning_message" style="display: flex;justify-content: center;align-items: center;padding:5px">
            <a style="font-weight: bold;font-size: 12px;color: #34495e;text-align:center;">TRIAL MODE</a>
        </div>

    </div>

    <?php }} 
if($pembayaran[0]->id_user != 1) {
...
?>
    ...
    <div class="blocked" style="z-index:99999999;background:#f5f6fa;position:absolute;left:0;right:0;top:0;bottom:0;">
        ...
        <div class="blocked_message"
            ...
            <a style="font-weight: bold;font-size: 22px;color: #e74c3c;">Undangan Tidak Aktif!</a>
            <a style="font-weight: bold;font-size: 13px;color: #34495e;text-align:center;">Segera lakukan pembayaran
                agar undangan anda bisa aktif kembali!</a>
        </div>
...
?>
    ...
    <div class="thebegining">
        ...
        <div class="salam">
            ...
            <a style="font-weight: normal;font-size:18px;">
                <?php 
        if(!empty(esc($invite))){
            echo esc($invite);
        }
        ?></a><br>
            <a style="font-weight: normal;font-size:18px;color: #2f3640;font-family: sans-serif;">We invite You to
                attend our wedding</a>
        </div>
        <a style="font-weight: bold;font-size: 12px;color: #2f3640;position: absolute;bottom: 20px;right: 0;left: 0;">klik
	...
	?>
                ...
                <tbody>
                    ...
                    <tr>
                        <th style="position: relative;text-align: center;display:block;margin-top:40px">
                            ...
                            <!-- image border cover -->
                            <img src="<?= base_url() ?>/assets/themes/tealflower/img/bg-flower.png"
                    ...
                    <tr>
                        <th style="text-align: center;margin-top:40px;margin-bottom:15px;display: block;">
                            <span class="nama-mempelai"><?php echo $row->nama_panggilan_pria; ?> &
                                <?php echo $row->nama_panggilan_wanita; ?></span>
                        </th>
                    </tr>
                    <tr>
                        <th style="text-align: center;">
        ...
        <div id="mempelai-konten" class="konten" style="display: none;">
            ...
            <p class="mempelai-pria-ortu">
                <?php echo "Putra Bpk ".$row->nama_ayah_pria . " dan Ibu " .$row->nama_ibu_pria  ?></p>
            ...
            <p class="mempelai-wanita-ortu">
                <?php echo "Putri Bpk ".$row->nama_ayah_wanita . " dan Ibu " .$row->nama_ibu_wanita  ?></p>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="tb-isi-acara">
                                <?php echo $row->tempat_akad; ?><br><?php echo $row->alamat_akad; ?></th>
                        </tr>
                ...
                <table class="tb-acara">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th class="tb-ket-acara"> Tanggal</th>
                            <th class="tb-anu-acara">:</th>
                            <th class="tb-isi-acara " id="tanggal-acara-resepsi"><?php echo $row->tanggal_resepsi; ?>
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th class="tb-anu-acara">:</th>
                            <th class="tb-isi-acara">
                                <?php echo $row->tempat_resepsi; ?><br><?php echo $row->alamat_resepsi; ?></th>
                        </tr>
                            ...
                            <div class="gallery-grids">
                                ...
                                <div class="grid">
                                    <a href="<?php echo base_url() ?>/assets/users/<?php echo $kunci.'/'.$data['album'] ?>.png"
                                        ...
                                        <img src="<?php echo base_url() ?>/assets/users/<?php echo $kunci.'/'.$data['album']; ?>.png"
                                            alt>
                                    </a>
                                </div>
                        ...
                        <div class="col col-xs-12">
                            <div class="youtube">
                                <a href="<?php echo $embed; ?>" data-type="iframe" class="video-play-btn">
                                    <img src="https://img.youtube.com/vi/<?php echo $unikfinal; ?>/maxresdefault.jpg"
        ...
        <div class="container-fluid px-0">
            <div class="row no-gutters">
                <div class="col-12" style="display: flex;margin-bottom: 5px;margin-top: 5px; " id="hehe">
                    ...
                    <div class="mobile-bottom-nav__item" id="ucapan" <?php 
                if($row->gallery != 1)
        ...
        <div class="container-fluid px-0">
            <div class="row no-gutters">
                <div class="col-12" style="display: flex;margin-bottom: 5px;margin-top: 5px;">
                    <?php foreach ($rules->getResult() as $row){ ?>
                    <div class="mobile-bottom-nav__item" id="album" <?php 
                if($row->gallery != 1)
                    echo "style=display:none;"
                ?>>
                        <div class="mobile-bottom-nav__item-content icons">
                    ...
                    <div class="mobile-bottom-nav__item" id="cerita" <?php 
                if($row->cerita != 1)
                    echo "style=display:none;"
                ?>>
                        <div class="mobile-bottom-nav__item-content icons">
                    ...
                    <div class="mobile-bottom-nav__item" id="lokasi" <?php 
                if($row->lokasi != 1)
                    echo "style=display:none;"
                ?>>
                        <div class="mobile-bottom-nav__item-content icons">
...
<script>
var tanggal_akad = '<?php echo $tanggal_akad; ?>';
</script>
<script>
var tanggal_resepsi = '<?php echo $tanggal_resepsi; ?>';
</script>
<!-- mengirimkan data php ke javascript -->
