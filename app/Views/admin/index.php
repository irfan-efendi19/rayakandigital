        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a class="m-0 float-right btn btn-danger btn-sm" href="<?= base_url('admin/pembayaran') ?>">Lihat
                        Lebih <i class="fas fa-chevron-right"></i></a>
                </div>
                <div class="table-responsive">
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><?= $row->username ?></td>
                                <td><a target="_blank"
                                        href="<?= SITE_UNDANGAN.'/'.$row->domain ?>"><?= $row->domain ?></a></td>
                                <?php 
                        ...
                        ?>
                                ...
                                <td>
                                    <div class="btn-group mb-1">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a href="#" class="dropdown-item" data-nama="<?= $row->nama_lengkap ?>"
                                                data-bank="<?= $row->nama_bank ?>" data-invoice="<?= $row->invoice ?>"
                                                data-toggle="modal" data-target="#modalData">Lihat</a>
                                ...
                                <?php }else{ ?>
                                <td><a href="#" class="btn btn-primary btn-sm konfirmasiBtn"
                                        data-id="<?= $row->id_user ?>" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col mt-2">
                        ...
                        <input id="nama_lengkap" type="text" class="form-control" placeholder="Contoh : Dinda Rahma"
                            value="" required>
                    </div>
                    <div class="col mt-2">
                        <label>Nama Bank</label>
                        <input id="nama_bank" type="text" class="form-control" placeholder="Contoh : BRI Syariah "
                            value="" required>
                    </div>
