...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTema"
            ...
            <li class="nav-item">
                ...
                <div id="collapseSetting" class="collapse" aria-labelledby="headingTable"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="ml-2 d-none d-lg-inline text-white small"><?= $_SESSION['uname_admin'] ?></span>
                            </a>
