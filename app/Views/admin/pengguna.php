                    ...
                    ?>
                        ...
                        $masa_aktif = $row->masa_aktif;
                          ...
                          ?>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?php echo base_url('admin/edit_pengguna/mempelai'); ?>">
                                        <input type="hidden" value="<?= $row->id_user ?>" name="id">
                                        <button class="btn btn-sm btn-primary" type="submit">Edit</button>
                                    </form>
                                    <button data-id="<?= $row->id_user?>" data-kunci="<?= $row->kunci?>"
                                        class="btn btn-sm btn-danger hapus" data-toggle="modal"
