        ...
        <div class="container">
            <div class="row justify-content-center">
                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <input name="tanggal_cerita[]" name="tanggal_cerita[]" type="text"
                                            class="form-control" placeholder="Contoh : 14 Januari 2020 "
                                            value="<?php if(isset($_SESSION['tanggal_cerita0'])) echo $_SESSION['tanggal_cerita0'] ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col">
                                        ...
                                        <input name="judul_cerita[]" type="text" class="form-control"
                                            ...
                                            value="<?php if(isset($_SESSION['judul_cerita0'])) echo $_SESSION['judul_cerita0'] ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col">
                                        ...
                                        <textarea name="isi_cerita[]" type="text" class="form-control"
                                            ...
                                            required><?php if(isset($_SESSION['isi_cerita0'])) echo $_SESSION['isi_cerita0'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="cerita2">
                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <input name="tanggal_cerita[]" type="text" class="form-control"
                                            ...
                                            value="<?php if(isset($_SESSION['tanggal_cerita1'])) echo $_SESSION['tanggal_cerita1'] ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col">
                                        <label>Judul</label>
                                        <input name="judul_cerita[]" type="text" class="form-control"
                                            placeholder="Contoh : Ta'aruf"
                                            value="<?php if(isset($_SESSION['judul_cerita1'])) echo $_SESSION['judul_cerita1'] ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col">
                                        ...
                                        <textarea name="isi_cerita[]" type="text" class="form-control"
                                            placeholder="Maximal 500 Karakter" maxlength="500" rows="4"
                                            required><?php if(isset($_SESSION['isi_cerita1'])) echo $_SESSION['isi_cerita1'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="cerita<?php echo $i+1 ?>">
                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <input name="tanggal_cerita[]" type="text" class="form-control"
                                            placeholder="Contoh : 20 Februari 2020"
                                            value="<?php if(isset($_SESSION['tanggal_cerita'.$i])) echo $_SESSION['tanggal_cerita'.$i] ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col">
                                        ...
                                        <input name="judul_cerita[]" type="text" class="form-control"
                                            placeholder="Contoh : Ta'aruf"
                                            value="<?php if(isset($_SESSION['judul_cerita'.$i])) echo $_SESSION['judul_cerita'.$i] ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col">
                                        ...
                                        <textarea name="isi_cerita[]" type="text" class="form-control"
                                            placeholder="Maximal 500 Karakter" maxlength="500" rows="4"
                                            required><?php if(isset($_SESSION['isi_cerita'.$i])) echo $_SESSION['isi_cerita'.$i] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <?php }
              ...
              ?>
                        ...
                        <div class="row mt-2">
                            <div class="col text-center">
                                <a id="addCerita" class="btn btn-primary btn-order btn-order-secondary btn-block">Tambah
                                    Cerita</a>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-start mt-3">
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <a href="<?php echo base_url('order/3'); ?>"
                                            class="btn btn-secondary btn-order">Kembali</a>
                                    </div>
                                    <div class="col">
                                        <input name="submit" type="submit" class="btn btn-primary btn-order btn-block"
                                            style="background-color: #3498db;" value="Lanjut">
                                    </div>
                                </div>
                            </div>
                        </div>
