          ...
          <div class="col-12 col-md-8 col-lg-8 col-xl-6">
            <div class="row">
              <div class="col text-center">
                <h1 style="color: #fa9a00;margin-bottom:0px;">Informasi Mempelai!</h1>
            ...
            <div class="row justify-content-start mt-4" >
              <div class="col">
                <div class="row">
                  ...
                  <div class="col">
                    <input name="submit" type="submit" class="btn btn-primary btn-order btn-block" style="background-color: #fa9a00;" value="Lanjut">
                  </div>
                </div>   
              </div>
            </div>
