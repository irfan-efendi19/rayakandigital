                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="<?= SITE_UNDANGAN?>/<?= $domain ?>" target="_blank"
                                        class="btn btn-primary btn-order btn-block">Review Undangan</a>
                                </div>
...
mohon infonya " ?>
                                    ...
                                    <a href="<?= base_url('user/logout') ?>" target="_blank"
                                        class="btn btn-success btn-order btn-block">Login Dashboard</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-check mt-4" style="text-align: center;">
                        <h3 class="form-check-label" <?php if($status == 2)echo "style='display:none'" ?>>
                            Untuk melakukan aktifasi silahkan login dengan email dan password yang anda buat atau bisa
                            menghubungi admin via <a
                                href="https://api.whatsapp.com/send?phone=<?= $setting[0]->no_wa; ?>&text=<?php echo urlencode($format) ?>">Whatsapp</a>
                            dengan menyertakan <strong>kode :<h2 style="color:red; size:30px; text:bold;">#<?= $kode ?>
                                </h2></strong>
                        </h3>
                    </div>
