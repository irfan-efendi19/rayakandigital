                    ...
                    <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                        ...
                        <div class="row">
                            <div class="col text-left">
                                <p tyle="font-size: 15px;font-weight:500; ">1. Pastikan video kamu sudah di upload di
                                    Youtube.com</p>
                                <p tyle="font-size: 15px;font-weight:500; ">2. Setelah itu buka vide kamu di youtube dan
                                    tekan tombol bagikan</p>
                                <img src="<?= base_url() ?>/assets/base/img/tutorial/youtube1.png" width="100%">
                                <p tyle="font-size: 15px;font-weight:500; ">3. Akan muncul tampilan seperti gambar di
                                    bawah ini, copy link nya dengan menekan tombol salin</p>
                                <img src="<?= base_url() ?>/assets/base/img/tutorial/youtube2.png" width="100%">
                                <p tyle="font-size: 15px;font-weight:500; ">4. Ingat!! pastikan link youtube nya
                                    formatnya sama seperti digambar <strong>https://youtu.be/</strong> </p>
                                <p tyle="font-size: 15px;font-weight:500; ">5. Terakhir tinggal kamu masukkan linknya ke
                                    dalam form yang sudah disediakan kemudian simpan</p>
