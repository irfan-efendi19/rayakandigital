...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php if($_SESSION['kirim_hadiah'] == 1) { ?><a class="collapse-item"
                            href="<?= base_url('user/rekening'); ?>">Rekening</a><?php } ?>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePengunjung"
                    aria-expanded="true" aria-controls="collapsePengunjung">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Pengunjung</span>
                </a>
                <div id="collapsePengunjung" class="collapse" aria-labelledby="headingTable"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTamu"
                    aria-expanded="true" aria-controls="collapseTamu">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?= base_url('assets/dashboard'); ?>/img/boy.png" style="max-width: 60px">
