                ...
                <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <input name="nama_bank[]" type="text" class="form-control"
                                        ...
                                        value="<?= $rekening[$i]->nama_bank ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center mt-3">
                                <div class="col">
                                    ...
                                    <input name="no_rekening[]" type="text" class="form-control"
                                        placeholder="Contoh : 0123456" value="<?= $rekening[$i]->no_rekening  ?>"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center mt-3">
                                <div class="col">
                                    ...
                                    <input name="nama_pemilik[]" type="text" class="form-control"
                                        placeholder="Contoh : Admin" value="<?= $rekening[$i]->nama_pemilik  ?>"
                                        required>
                                </div>
                            </div>
                            <div class="row align-items-center mt-3">
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <div class="upload-area" style="height: 100%;padding: 5px 5px;">
                                                ...
                                                <img <?php if(!empty($rekening[$i]->qrcode_bank)) { ?>
                                                    src="<?= base_url() ?>/assets/users/<?= $kunci ?>/rekening/<?= $rekening[$i]->qrcode_bank ?>"
                                                    <?php } ?> id="img_qrcode<?= $i+1 ?>"
                                        ...
                                        <div
                                            ...
                                            <div class="btn btn-primary">
                                                <input type="hidden" name="nama_qrcode[]"
                                                    value="<?= $rekening[$i]->qrcode_bank ?>">
                                                <input type="file" class="file-upload" id="qrcode<?= $i+1 ?>"
                                                    name="qrcode_picture[]" accept="image/*"
                                                    onchange="preview_image(event)"> Upload Foto
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-2">
                        <div class="col text-center">
                            <a id="addRekening" class="btn btn-primary btn-order btn-order-secondary btn-block"
                                style="color:#fff">Tambah Rekening</a>
                        </div>
                    </div>
...
$('#addRekening').click(function() {
    ...
    $('#konten-rekening').append('<div id="rekening' + i +
        ...
        '" class="btn btn-sm btn_remove" style="background-color: #dc3545;padding: 5px;font-size: 12px;border-radius: 5px;">Hapus</a></div></div><div class="row align-items-center"><div class="col"><label>Nama Bank</label><input name="nama_bank[]" type="text" class="form-control" placeholder="Contoh : BANK NEGARA INDONESIA " required></div></div><div class="row align-items-center mt-3"><div class="col"><label>No Rekening</label><input name="no_rekening[]" type="text" class="form-control" placeholder="Contoh : 123456" required></div></div><div class="row align-items-center mt-3"><div class="col"><label>Nama Pemilik</label><input name="nama_pemilik[]" type="text" class="form-control" placeholder="Contoh : Admin " required></div></div><div class="row align-items-center mt-3"><div class="col"><div class="row"><div class="col-12 col-md-6 col-lg-6 d-flex align-items-center justify-content-center"><div class="upload-area" style="height: 100%;padding: 5px 5px;"><img id="img_qrcode' +
        i +
        '" style="border-radius: 5px;height: 200px;width: 200px;"></div></div><div class="col-12 col-md-6 col-lg-6 d-flex align-items-center justify-content-center mt-3"><div class="btn btn-primary"><input type="hidden" name="nama_qrcode[]"><input type="file" class="file-upload" id="qrcode' +
        i +
        '"  name="qrcode_picture[]" accept="image/*" onchange="preview_image(event)"> Upload Foto</div></div></div></div></div></div>'
    );
