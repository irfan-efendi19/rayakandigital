 ...
 <div class="container-fluid" id="container-wrapper">
     ...
     <div class="row mb-3">
             ...
             <div class="card">
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    if($pembayaran[0]->status == 0){ ?>
                     <h6 class="m-0 font-weight-bold " style="color:red">Invoice : Masa Trial Anda Akan Berakhir pada
                         tanggal <?= $tglExpFormated ?>, Segera lakukan pembayaran</h6>
                     <?php }else if($pembayaran[0]->status == 1){ 
                    if($metode_bayar == 'manual') {?>
                     <h6 class="m-0 font-weight-bold " style="color:orange">Invoice : Pembayaran anda menunggu
                         konfirmasi</h6>
                     <?php }else{ ?>
                     <h6 class="m-0 font-weight-bold " style="color:orange">Invoice : Selesaikan Pembayaran anda sebelum
                         <?= $expiry_date ?> </h6>
                     <?php }
                    } else if($pembayaran[0]->status == 2 && $today >= $tglNonaktif ){ 
                    ?>
                     <h6 class="m-0 font-weight-bold " style="color:red"> Masa Aktif Undangan sudah habis pada tanggal
                         <?= $tglNonaktifFormated ?>, Silahkan lakukan pembayaran lagi untuk memperpanjang masa aktif
                         undangan </h6>
                     <?php }else{ ?>
                     <h6 class="m-0 font-weight-bold " style="color:green">Undangan Anda aktif sampai tanggal
                         <?= $tglNonaktifFormated ?></h6>
                     <?php } ?>
                 </div>
             </div>
         </div>
                 ...
                 <div class="card-body">
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg"
                             style="margin-top: 5px;text-align: center;background: #f1f2f6 !important;">
                             <div class="col">
                                 <div class="row">
                                     <div class="col">
                                         <a
                                             style="font-size: 16px;text-transform: uppercase;color: #2c3e50;font-weight:600;">#<?= $pembayaran[0]->invoice ?></a>
                                     </div>
                                     <div class="col-auto">
                                         <?php if($pembayaran[0]->status == 2){ 
                                    if($pembayaran[0]->status == 2 && $today >= $tglNonaktif ){ ?>
                                         <button id="re_order" class="btn-danger btn-sm btn"
                                             title="refresh perpanjangan"><i class="fas fa-sync-alt"
                                         ...
                                         <button id="refresh" class="btn-danger btn-sm btn"
                                             title="refresh pembayaran"><i class="fas fa-sync-alt"
                                                 aria-hidden="true"></i></button>
                                        ...
                                        ?>
                                         ...
                                         <?php } ?>
                                         <button id="paket" class="btn-primary btn-sm btn" title="ubah paket"
                                             data-toggle="modal" data-target="#modalPaket"><i
                     ...
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg" style="margin-top: 5px;text-align: center;background: #f1f2f6;">
                             <a
                                 style="font-size: 18px;color: #2c3e50;font-weight:bolder"><?= rupiah($pembayaran[0]->harga) ?></a>
                         </div>
                     </div>
                     ...
                     <button class="btn btn-primary btn-block" data-toggle="modal"
                         data-target="#modalKonfirmasi">Konfirmasi</button>
                     <?php }else if ($metode_bayar == 'midtrans'){ ?>
                     <button class="btn btn-primary btn-block" id="pay-button">Pembayaran</button>
                     <?php } else{ ?>
                     <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#modalTripay">Pembayaran
                         Tagihan</button>
                     <?php }
                    }?>
                 </div>
         ...
         <div class="col-xl-6 col-lg-6 mb-4"
             style="<?php if($metode_bayar == 'manual') { echo 'display:block'; } else { if($pembayaran[0]->status != 0){ echo 'display:block'; } else{ echo 'display:none'; } }?>">
             <div class="card mb-4">
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                 ...
                 <div class="card-body">
                     ...
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg d-flex justify-content-between"
                             ...
                             <img src="<?= base_url() ?>/assets/base/img/bank.png" height="40px">
                             <a
                                 style="font-size: 16px;text-transform: uppercase;color: #2c3e50;"><?= $setting_bayar[0]->bank_manual ?></a>
                         </div>
                     </div>
                     ...
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg d-flex justify-content-between"
                             ...
                             <a style="font-size: 18px;text-transform: uppercase;color: #2c3e50;"><span
                                     id="norek"><?= $setting_bayar[0]->norek_manual ?></span></a>
                     ...
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg" style="margin-top: 5px;text-align: center;background: #f1f2f6;">
                             <a
                                 style="font-size: 18px;text-transform: uppercase;color: #2c3e50;"><?= strtoupper($setting_bayar[0]->nama_manual) ?></a>
                         </div>
                     </div>
                     <?php } else {?>
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg d-flex justify-content-between"
                             style="margin-top: 5px;text-align: center;background: #f1f2f6;">
                             <a
                                 style="font-size: 16px;text-transform: uppercase;color: #2c3e50;"><?= $pembayaran[0]->nama_bank ?></a>
                         </div>
                     </div>
                     ...
                     <div class="form-group">
                         ...
                         <div class="upload-area-bg d-flex justify-content-between"
                             style="margin-top: 5px;text-align: center;background: #f1f2f6;">
                             <a style="font-size: 18px;text-transform: uppercase;color: #2c3e50;"><span
                                     id="biller_code"><?= $pembayaran[0]->biller_code ?></span></a>
                             <button class="btn btn-sm btn-secondary"
                                 onclick="copyToClipboard('#biller_code')">Salin</button>
                         </div>
                     </div>
                     <?php } ?>
                     <div class="form-group">
 ...
 <!-- Modal -->
 <div class="modal fade" id="modalMenunggu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
 ...
 <div class="modal fade" id="modalKonfirmasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
             ...
             <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('user/konfirmasi'); ?>">
                 <div class="modal-body">
                     <div class="col mt-2">
                         ...
                         <input name="nama_lengkap" type="text" class="form-control" placeholder="Contoh : Dinda Rahma"
                             value="" required>
                     </div>
                     <div class="col mt-2">
                         <label>Nama Bank</label>
                         <input name="nama_bank" type="text" class="form-control" placeholder="Contoh : BRI " value=""
                             required>
                     </div>
 ...
 <div class="modal fade" id="modalTripay" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
             ...
             <form method="POST" enctype="multipart/form-data"
                 action="<?php echo base_url('user/pembayaran_tripay'); ?>">
                 <div class="modal-body">
                     <div class="col mt-2">
                     ...
                     <div class="card">
                         ...
                         <div id="heading<?= $i+1; ?>" class="card-header bg-white shadow-sm border-0">
                             <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse"
                                     data-target="#collapse<?= $i+1; ?>" aria-expanded="false"
                                     aria-controls="collapse<?= $i+1; ?>"
                                     class="d-block position-relative text-dark text-uppercase collapsible-link py-2"><?= $detail->title ?></a>
                             </h6>
                         </div>
                         <div id="collapse<?= $i+1; ?>" aria-labelledby="headingOne" data-parent="#accordionExample"
                             class="collapse">
                             <div class="card-body">
                                 <ul>
                 ...
                 <div class="modal-body">
                     <div class="col mt-2">
                         ...
                         <select class="form-control" id="id_paket" name="id_paket" required>
                             ...
                             <option value="<?= $row->id_paket ?>">Paket <?= $row->nama_paket ?> - Harga Rp
                                 <?= number_format($row->harga_paket) ?></option>
                             <?php endforeach; ?>
                         </select>
                     </div>
                 </div>
