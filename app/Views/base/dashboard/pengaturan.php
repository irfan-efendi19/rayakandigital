...
<div class="container-fluid" id="container-wrapper">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input id="token_wa" type="text" class="form-control"
                            placeholder="Masukan Token Whatsapp Gateway anda" value="<?= $data[0]->token_wa ?>"
                            required>
                        <?php if ($setting[0]->wa_gateway != "onesender") { ?><small><i>Kosongkan Jika tidak memiliki
                                Token Whatsapp Gateway atau <a target="_blank"
                                    href="<?php if ($setting[0]->wa_gateway == 'nusagateway') { echo 'https://nusagateway.com'; }else if($setting[0]->wa_gateway == "starsender") { echo 'https://starsender.online' ;} ?>">Klik
                                    Disini</a></i></small>
                        <?php } ?>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                <textarea rows="4" id="salam_pembuka" class="form-control"
                                    required><?= $data[0]->salam_pembuka ?></textarea>
                            </div>
                        </div>
                        <label>Salam Pembuka Whatsapp (Atas) </label>
                        <div class="form-group">
                            <div class="custom-file">
                                <textarea rows="4" id="salam_wa_atas" class="form-control"
                                    required><?= $data[0]->salam_wa_atas ?></textarea>
                            </div>
                        </div>
                        <label>Salam Pembuka Whatsapp (Bawah) </label>
                        <div class="form-group">
                            <div class="custom-file">
                                <textarea rows="4" id="salam_wa_bawah" class="form-control"
                                    required><?= $data[0]->salam_wa_bawah ?></textarea>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modalToken" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modalSalam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
